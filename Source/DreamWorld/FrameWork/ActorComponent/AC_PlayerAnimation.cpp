...
void UAC_PlayerAnimation::InitBasicAttackAnimation()
{
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage> NoWeaponBaiscAttackObject(TEXT("AnimMontage'/Game/Animation/Player/Anim/Montage/Attack/AM_PlayerBasicJab.AM_PlayerBasicJab'"));
